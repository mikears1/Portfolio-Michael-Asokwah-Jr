...
5. (adventureworkssales.pbix) This interactive dashboard, created using PowerBI, utilises the sample Microsoft AdventureWorks sales Excel Workbook. The  dashboard analyzes sales by month, region, category, and reseller, and provides a table for the viewer to sort products by popularity or total revenue from sales. There is also a concept logo for the company, created using Adobe Photoshop. 
